...
state.tellGenerationChange = function(generation) {
    ...
    state.changeGenerationEvent.detail = {
...
view.create = function(nx, ny, width, height) {
    view.layer = [];
    view.layer[0] = elt("canvas", {
        id: "rayer0",
        width: width,
        height: height
    });
    view.layer[1] = elt("canvas", {
        id: "rayer1",
        width: width,
        height: height
    });
    ...
    view.lineWidth = 0.2;
    view.drawLattice();
    view.generation = elt("span", {
        id: "generation"
    });
    view.statuspanel = elt("div", {
        class: "status"
    }, "세대: ", view.generation);
    ...
    return elt("div", {
        class: "viewpanel"
    }, view.layer[0], view.layer[1], view.statuspanel);
};
